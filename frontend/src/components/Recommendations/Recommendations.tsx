...
const About: React.FC = () => {
    ...
    const selectedTags = appStateContext?.state?.selectedTags;
    ...
    const fetch = async () => {
        ...
        try {
            ...
            if(storeuserinfo){
                ...
                // if(storageval.splitReq) 
                // {
                //     console.log("splitReq", storageval.splitReq)
                //     const StateCity = storageval.split(',');
                ...
                // else {
                console.log("splitReq", storageval.splitReq)
                cityname = storageval[0].city || ""
                statename = storageval[0].state || ""
                //}


            }
            const response =await getRecommendations(promptValue || '', cityname , statename , selectedTags)
            // const response = {
